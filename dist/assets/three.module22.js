...
#endif`,th="gl_FragColor = linearToOutputTexel( gl_FragColor );",ih=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function ks(){return new pi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zn(),fragmentShader:`
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function Ws(){return new pi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zn(),fragmentShader:`
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function Zn(){return`
...
}`;function qp(r,e,t){let i=new Yn;const a=new Be,n=new Be,s=new it,o=new gc({depthPacking:Al}),c=new _c,l={},u=t.maxTextureSize,p={[di]:Mt,[Mt]:di,[ti]:ti},d=new pi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Be},radius:{value:4}},vertexShader:Xp,fragmentShader:jp}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const _=new Pt;_.setAttribute("position",new Ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new zt(_,d),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=lo;let h=this.type;this.render=function(R,C,L){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||R.length===0)return;const S=r.getRenderTarget(),M=r.getActiveCubeFace(),w=r.getActiveMipmapLevel(),F=r.state;F.setBlending(hi),F.buffers.depth.getReversed()?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const V=h!==ei&&this.type===ei,H=h===ei&&this.type!==ei;for(let K=0,X=R.length;K<X;K++){const Q=R[K],G=Q.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;a.copy(G.mapSize);const te=G.getFrameExtents();if(a.multiply(te),n.copy(G.mapSize),(a.x>u||a.y>u)&&(a.x>u&&(n.x=Math.floor(u/te.x),a.x=n.x*te.x,G.mapSize.x=n.x),a.y>u&&(n.y=Math.floor(u/te.y),a.y=n.y*te.y,G.mapSize.y=n.y)),G.map===null||V===!0||H===!0){const Pe=this.type!==ei?{minFilter:Tt,magFilter:Tt}:{};G.map!==null&&G.map.dispose(),G.map=new Pi(a.x,a.y,Pe),G.map.texture.name=Q.name+".shadowMap",G.camera.updateProjectionMatrix()}r.setRenderTarget(G.map),r.clear();const pe=G.getViewportCount();for(let Pe=0;Pe<pe;Pe++){const Ie=G.getViewport(Pe);s.set(n.x*Ie.x,n.y*Ie.y,n.x*Ie.z,n.y*Ie.w),F.viewport(s),G.updateMatrices(Q,Pe),i=G.getFrustum(),y(C,L,G.camera,Q,this.type)}G.isPointLightShadow!==!0&&this.type===ei&&T(G,L),G.needsUpdate=!1}h=this.type,f.needsUpdate=!1,r.setRenderTarget(S,M,w)};function T(R,C){const L=e.update(x);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Pi(a.x,a.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,r.setRenderTarget(R.mapPass),r.clear(),r.renderBufferDirect(C,null,L,d,x,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,r.setRenderTarget(R.map),r.clear(),r.renderBufferDirect(C,null,L,m,x,null)}function b(R,C,L,S){let M=null;const w=L.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(w!==void 0)M=w;else if(M=L.isPointLight===!0?c:o,r.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const F=M.uuid,V=C.uuid;let H=l[F];H===void 0&&(H={},l[F]=H);let K=H[V];K===void 0&&(K=M.clone(),H[V]=K,C.addEventListener("dispose",P)),M=K}if(M.visible=C.visible,M.wireframe=C.wireframe,S===ei?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:p[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const F=r.properties.get(M);F.light=L}return M}function y(R,C,L,S,M){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&M===ei)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,R.matrixWorld);const F=e.update(R),V=R.material;if(Array.isArray(V)){const H=F.groups;for(let K=0,X=H.length;K<X;K++){const Q=H[K],G=V[Q.materialIndex];if(G&&G.visible){const te=b(R,G,S,M);R.onBeforeShadow(r,R,C,L,F,te,Q),r.renderBufferDirect(L,null,F,te,R,Q),R.onAfterShadow(r,R,C,L,F,te,Q)}}}else if(V.visible){const H=b(R,V,S,M);R.onBeforeShadow(r,R,C,L,F,H,null),r.renderBufferDirect(L,null,F,H,R,null),R.onAfterShadow(r,R,C,L,F,H,null)}}const w=R.children;for(let F=0,V=w.length;F<V;F++)y(w[F],C,L,S,M)}function P(R){R.target.removeEventListener("dispose",P);for(const C in l){const L=l[C],S=R.target.uuid;S in L&&(L[S].dispose(),delete L[S])}}}const Yp={[en]:tn,[rn]:sn,[an]:on,[tr]:nn,[tn]:en,[sn]:rn,[on]:an,[nn]:tr};function Kp(r,e){function t(){let D=!1;const ee=new it;let re=null;const ge=new it(0,0,0,0);return{setMask:function(J){re!==J&&!D&&(r.colorMask(J,J,J,J),re=J)},setLocked:function(J){D=J},setClear:function(J,q,me,Te,st){st===!0&&(J*=Te,q*=Te,me*=Te),ee.set(J,q,me,Te),ge.equals(ee)===!1&&(r.clearColor(J,q,me,Te),ge.copy(ee))},reset:function(){D=!1,re=null,ge.set(-1,0,0,0)}}}function i(){let D=!1,ee=!1,re=null,ge=null,J=null;return{setReversed:function(q){if(ee!==q){const me=e.get("EXT_clip_control");q?me.clipControlEXT(me.LOWER_LEFT_EXT,me.ZERO_TO_ONE_EXT):me.clipControlEXT(me.LOWER_LEFT_EXT,me.NEGATIVE_ONE_TO_ONE_EXT),ee=q;const Te=J;J=null,this.setClear(Te)}},getReversed:function(){return ee},setTest:function(q){q?ae(r.DEPTH_TEST):Ee(r.DEPTH_TEST)},setMask:function(q){re!==q&&!D&&(r.depthMask(q),re=q)},setFunc:function(q){if(ee&&(q=Yp[q]),ge!==q){switch(q){case en:r.depthFunc(r.NEVER);break;case tn:r.depthFunc(r.ALWAYS);break;case rn:r.depthFunc(r.LESS);break;case tr:r.depthFunc(r.LEQUAL);break;case an:r.depthFunc(r.EQUAL);break;case nn:r.depthFunc(r.GEQUAL);break;case sn:r.depthFunc(r.GREATER);break;case on:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}ge=q}},setLocked:function(q){D=q},setClear:function(q){J!==q&&(ee&&(q=1-q),r.clearDepth(q),J=q)},reset:function(){D=!1,re=null,ge=null,J=null,ee=!1}}}function a(){let D=!1,ee=null,re=null,ge=null,J=null,q=null,me=null,Te=null,st=null;return{setTest:function(ke){D||(ke?ae(r.STENCIL_TEST):Ee(r.STENCIL_TEST))},setMask:function(ke){ee!==ke&&!D&&(r.stencilMask(ke),ee=ke)},setFunc:function(ke,qt,Vt){(re!==ke||ge!==qt||J!==Vt)&&(r.stencilFunc(ke,qt,Vt),re=ke,ge=qt,J=Vt)},setOp:function(ke,qt,Vt){(q!==ke||me!==qt||Te!==Vt)&&(r.stencilOp(ke,qt,Vt),q=ke,me=qt,Te=Vt)},setLocked:function(ke){D=ke},setClear:function(ke){st!==ke&&(r.clearStencil(ke),st=ke)},reset:function(){D=!1,ee=null,re=null,ge=null,J=null,q=null,me=null,Te=null,st=null}}}const n=new t,s=new i,o=new a,c=new WeakMap,l=new WeakMap;let u={},p={},d=new WeakMap,m=[],_=null,x=!1,f=null,h=null,T=null,b=null,y=null,P=null,R=null,C=new Fe(0,0,0),L=0,S=!1,M=null,w=null,F=null,V=null,H=null;const K=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,Q=0;const G=r.getParameter(r.VERSION);G.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(G)[1]),X=Q>=1):G.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),X=Q>=2);let te=null,pe={};const Pe=r.getParameter(r.SCISSOR_BOX),Ie=r.getParameter(r.VIEWPORT),$e=new it().fromArray(Pe),Xe=new it().fromArray(Ie);function W(D,ee,re,ge){const J=new Uint8Array(4),q=r.createTexture();r.bindTexture(D,q),r.texParameteri(D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(D,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let me=0;me<re;me++)D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY?r.texImage3D(ee,0,r.RGBA,1,1,ge,0,r.RGBA,r.UNSIGNED_BYTE,J):r.texImage2D(ee+me,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,J);return q}const ne={};ne[r.TEXTURE_2D]=W(r.TEXTURE_2D,r.TEXTURE_2D,1),ne[r.TEXTURE_CUBE_MAP]=W(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[r.TEXTURE_2D_ARRAY]=W(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ne[r.TEXTURE_3D]=W(r.TEXTURE_3D,r.TEXTURE_3D,1,1),n.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ae(r.DEPTH_TEST),s.setFunc(tr),qe(!1),Se(rs),ae(r.CULL_FACE),ct(hi);function ae(D){u[D]!==!0&&(r.enable(D),u[D]=!0)}function Ee(D){u[D]!==!1&&(r.disable(D),u[D]=!1)}function be(D,ee){return p[D]!==ee?(r.bindFramebuffer(D,ee),p[D]=ee,D===r.DRAW_FRAMEBUFFER&&(p[r.FRAMEBUFFER]=ee),D===r.FRAMEBUFFER&&(p[r.DRAW_FRAMEBUFFER]=ee),!0):!1}function _e(D,ee){let re=m,ge=!1;if(D){re=d.get(ee),re===void 0&&(re=[],d.set(ee,re));const J=D.textures;if(re.length!==J.length||re[0]!==r.COLOR_ATTACHMENT0){for(let q=0,me=J.length;q<me;q++)re[q]=r.COLOR_ATTACHMENT0+q;re.length=J.length,ge=!0}}else re[0]!==r.BACK&&(re[0]=r.BACK,ge=!0);ge&&r.drawBuffers(re)}function Ge(D){return _!==D?(r.useProgram(D),_=D,!0):!1}const je={[bi]:r.FUNC_ADD,[Qo]:r.FUNC_SUBTRACT,[el]:r.FUNC_REVERSE_SUBTRACT};je[tl]=r.MIN,je[il]=r.MAX;const A={[rl]:r.ZERO,[al]:r.ONE,[nl]:r.SRC_COLOR,[$a]:r.SRC_ALPHA,[ul]:r.SRC_ALPHA_SATURATE,[cl]:r.DST_COLOR,[ol]:r.DST_ALPHA,[sl]:r.ONE_MINUS_SRC_COLOR,[Qa]:r.ONE_MINUS_SRC_ALPHA,[hl]:r.ONE_MINUS_DST_COLOR,[ll]:r.ONE_MINUS_DST_ALPHA,[dl]:r.CONSTANT_COLOR,[pl]:r.ONE_MINUS_CONSTANT_COLOR,[fl]:r.CONSTANT_ALPHA,[ml]:r.ONE_MINUS_CONSTANT_ALPHA};function ct(D,ee,re,ge,J,q,me,Te,st,ke){if(D===hi){x===!0&&(Ee(r.BLEND),x=!1);return}if(x===!1&&(ae(r.BLEND),x=!0),D!==$o){if(D!==f||ke!==S){if((h!==bi||y!==bi)&&(r.blendEquation(r.FUNC_ADD),h=bi,y=bi),ke)switch(D){case $i:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case as:r.blendFunc(r.ONE,r.ONE);break;case ns:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ss:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case $i:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case as:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case ns:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ss:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}T=null,b=null,P=null,R=null,C.set(0,0,0),L=0,f=D,S=ke}return}J=J||ee,q=q||re,me=me||ge,(ee!==h||J!==y)&&(r.blendEquationSeparate(je[ee],je[J]),h=ee,y=J),(re!==T||ge!==b||q!==P||me!==R)&&(r.blendFuncSeparate(A[re],A[ge],A[q],A[me]),T=re,b=ge,P=q,R=me),(Te.equals(C)===!1||st!==L)&&(r.blendColor(Te.r,Te.g,Te.b,st),C.copy(Te),L=st),f=D,S=!1}function He(D,ee){D.side===ti?Ee(r.CULL_FACE):ae(r.CULL_FACE);let re=D.side===Mt;ee&&(re=!re),qe(re),D.blending===$i&&D.transparent===!1?ct(hi):ct(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),s.setFunc(D.depthFunc),s.setTest(D.depthTest),s.setMask(D.depthWrite),n.setMask(D.colorWrite);const ge=D.stencilWrite;o.setTest(ge),ge&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),fe(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ae(r.SAMPLE_ALPHA_TO_COVERAGE):Ee(r.SAMPLE_ALPHA_TO_COVERAGE)}function qe(D){M!==D&&(D?r.frontFace(r.CW):r.frontFace(r.CCW),M=D)}function Se(D){D!==Ko?(ae(r.CULL_FACE),D!==w&&(D===rs?r.cullFace(r.BACK):D===Zo?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ee(r.CULL_FACE),w=D}function Qe(D){D!==F&&(X&&r.lineWidth(D),F=D)}function fe(D,ee,re){D?(ae(r.POLYGON_OFFSET_FILL),(V!==ee||H!==re)&&(r.polygonOffset(ee,re),V=ee,H=re)):Ee(r.POLYGON_OFFSET_FILL)}function Ne(D){D?ae(r.SCISSOR_TEST):Ee(r.SCISSOR_TEST)}function ht(D){D===void 0&&(D=r.TEXTURE0+K-1),te!==D&&(r.activeTexture(D),te=D)}function rt(D,ee,re){re===void 0&&(te===null?re=r.TEXTURE0+K-1:re=te);let ge=pe[re];ge===void 0&&(ge={type:void 0,texture:void 0},pe[re]=ge),(ge.type!==D||ge.texture!==ee)&&(te!==re&&(r.activeTexture(re),te=re),r.bindTexture(D,ee||ne[D]),ge.type=D,ge.texture=ee)}function E(){const D=pe[te];D!==void 0&&D.type!==void 0&&(r.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function g(){try{r.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function O(){try{r.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function k(){try{r.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Y(){try{r.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{r.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ye(){try{r.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{r.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Me(){try{r.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function he(){try{r.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $(){try{r.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function le(D){$e.equals(D)===!1&&(r.scissor(D.x,D.y,D.z,D.w),$e.copy(D))}function Le(D){Xe.equals(D)===!1&&(r.viewport(D.x,D.y,D.z,D.w),Xe.copy(D))}function ve(D,ee){let re=l.get(ee);re===void 0&&(re=new WeakMap,l.set(ee,re));let ge=re.get(D);ge===void 0&&(ge=r.getUniformBlockIndex(ee,D.name),re.set(D,ge))}function oe(D,ee){const re=l.get(ee).get(D);c.get(ee)!==re&&(r.uniformBlockBinding(ee,re,D.__bindingPointIndex),c.set(ee,re))}function Oe(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),s.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},te=null,pe={},p={},d=new WeakMap,m=[],_=null,x=!1,f=null,h=null,T=null,b=null,y=null,P=null,R=null,C=new Fe(0,0,0),L=0,S=!1,M=null,w=null,F=null,V=null,H=null,$e.set(0,0,r.canvas.width,r.canvas.height),Xe.set(0,0,r.canvas.width,r.canvas.height),n.reset(),s.reset(),o.reset()}return{buffers:{color:n,depth:s,stencil:o},enable:ae,disable:Ee,bindFramebuffer:be,drawBuffers:_e,useProgram:Ge,setBlending:ct,setMaterial:He,setFlipSided:qe,setCullFace:Se,setLineWidth:Qe,setPolygonOffset:fe,setScissorTest:Ne,activeTexture:ht,bindTexture:rt,unbindTexture:E,compressedTexImage2D:g,compressedTexImage3D:O,texImage2D:he,texImage3D:$,updateUBOMapping:ve,uniformBlockBinding:oe,texStorage2D:ie,texStorage3D:Me,texSubImage2D:k,texSubImage3D:Y,compressedTexSubImage2D:j,compressedTexSubImage3D:ye,scissor:le,viewport:Le,reset:Oe}}function Zp(r,e,t,i,a,n,s){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Be,u=new WeakMap;let p;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,g){return m?new OffscreenCanvas(E,g):ca("canvas")}function x(E,g,O){let k=1;const Y=rt(E);if((Y.width>O||Y.height>O)&&(k=O/Math.max(Y.width,Y.height)),k<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const j=Math.floor(k*Y.width),ye=Math.floor(k*Y.height);p===void 0&&(p=_(j,ye));const ie=g?_(j,ye):p;return ie.width=j,ie.height=ye,ie.getContext("2d").drawImage(E,0,0,j,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+j+"x"+ye+")."),ie}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),E;return E}function f(E){return E.generateMipmaps}function h(E){r.generateMipmap(E)}function T(E){return E.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?r.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function b(E,g,O,k,Y=!1){if(E!==null){if(r[E]!==void 0)return r[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let j=g;if(g===r.RED&&(O===r.FLOAT&&(j=r.R32F),O===r.HALF_FLOAT&&(j=r.R16F),O===r.UNSIGNED_BYTE&&(j=r.R8)),g===r.RED_INTEGER&&(O===r.UNSIGNED_BYTE&&(j=r.R8UI),O===r.UNSIGNED_SHORT&&(j=r.R16UI),O===r.UNSIGNED_INT&&(j=r.R32UI),O===r.BYTE&&(j=r.R8I),O===r.SHORT&&(j=r.R16I),O===r.INT&&(j=r.R32I)),g===r.RG&&(O===r.FLOAT&&(j=r.RG32F),O===r.HALF_FLOAT&&(j=r.RG16F),O===r.UNSIGNED_BYTE&&(j=r.RG8)),g===r.RG_INTEGER&&(O===r.UNSIGNED_BYTE&&(j=r.RG8UI),O===r.UNSIGNED_SHORT&&(j=r.RG16UI),O===r.UNSIGNED_INT&&(j=r.RG32UI),O===r.BYTE&&(j=r.RG8I),O===r.SHORT&&(j=r.RG16I),O===r.INT&&(j=r.RG32I)),g===r.RGB_INTEGER&&(O===r.UNSIGNED_BYTE&&(j=r.RGB8UI),O===r.UNSIGNED_SHORT&&(j=r.RGB16UI),O===r.UNSIGNED_INT&&(j=r.RGB32UI),O===r.BYTE&&(j=r.RGB8I),O===r.SHORT&&(j=r.RGB16I),O===r.INT&&(j=r.RGB32I)),g===r.RGBA_INTEGER&&(O===r.UNSIGNED_BYTE&&(j=r.RGBA8UI),O===r.UNSIGNED_SHORT&&(j=r.RGBA16UI),O===r.UNSIGNED_INT&&(j=r.RGBA32UI),O===r.BYTE&&(j=r.RGBA8I),O===r.SHORT&&(j=r.RGBA16I),O===r.INT&&(j=r.RGBA32I)),g===r.RGB&&O===r.UNSIGNED_INT_5_9_9_9_REV&&(j=r.RGB9_E5),g===r.RGBA){const ye=Y?oa:Ve.getTransfer(k);O===r.FLOAT&&(j=r.RGBA32F),O===r.HALF_FLOAT&&(j=r.RGBA16F),O===r.UNSIGNED_BYTE&&(j=ye===We?r.SRGB8_ALPHA8:r.RGBA8),O===r.UNSIGNED_SHORT_4_4_4_4&&(j=r.RGBA4),O===r.UNSIGNED_SHORT_5_5_5_1&&(j=r.RGB5_A1)}return(j===r.R16F||j===r.R32F||j===r.RG16F||j===r.RG32F||j===r.RGBA16F||j===r.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function y(E,g){let O;return E?g===null||g===Ci||g===xr?O=r.DEPTH24_STENCIL8:g===Wt?O=r.DEPTH32F_STENCIL8:g===vr&&(O=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ci||g===xr?O=r.DEPTH_COMPONENT24:g===Wt?O=r.DEPTH_COMPONENT32F:g===vr&&(O=r.DEPTH_COMPONENT16),O}function P(E,g){return f(E)===!0||E.isFramebufferTexture&&E.minFilter!==Tt&&E.minFilter!==kt?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function R(E){const g=E.target;g.removeEventListener("dispose",R),L(g),g.isVideoTexture&&u.delete(g)}function C(E){const g=E.target;g.removeEventListener("dispose",C),M(g)}function L(E){const g=i.get(E);if(g.__webglInit===void 0)return;const O=E.source,k=d.get(O);if(k){const Y=k[g.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&S(E),Object.keys(k).length===0&&d.delete(O)}i.remove(E)}function S(E){const g=i.get(E);r.deleteTexture(g.__webglTexture);const O=E.source,k=d.get(O);delete k[g.__cacheKey],s.memory.textures--}function M(E){const g=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(g.__webglFramebuffer[k]))for(let Y=0;Y<g.__webglFramebuffer[k].length;Y++)r.deleteFramebuffer(g.__webglFramebuffer[k][Y]);else r.deleteFramebuffer(g.__webglFramebuffer[k]);g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer[k])}else{if(Array.isArray(g.__webglFramebuffer))for(let k=0;k<g.__webglFramebuffer.length;k++)r.deleteFramebuffer(g.__webglFramebuffer[k]);else r.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&r.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let k=0;k<g.__webglColorRenderbuffer.length;k++)g.__webglColorRenderbuffer[k]&&r.deleteRenderbuffer(g.__webglColorRenderbuffer[k]);g.__webglDepthRenderbuffer&&r.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const O=E.textures;for(let k=0,Y=O.length;k<Y;k++){const j=i.get(O[k]);j.__webglTexture&&(r.deleteTexture(j.__webglTexture),s.memory.textures--),i.remove(O[k])}i.remove(E)}let w=0;function F(){w=0}function V(){const E=w;return E>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+a.maxTextures),w+=1,E}function H(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function K(E,g){const O=i.get(E);if(E.isVideoTexture&&Ne(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&O.__version!==E.version){const k=E.image;if(k===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ne(O,E,g);return}}else E.isExternalTexture&&(O.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,O.__webglTexture,r.TEXTURE0+g)}function X(E,g){const O=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){ne(O,E,g);return}t.bindTexture(r.TEXTURE_2D_ARRAY,O.__webglTexture,r.TEXTURE0+g)}function Q(E,g){const O=i.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){ne(O,E,g);return}t.bindTexture(r.TEXTURE_3D,O.__webglTexture,r.TEXTURE0+g)}function G(E,g){const O=i.get(E);if(E.version>0&&O.__version!==E.version){ae(O,E,g);return}t.bindTexture(r.TEXTURE_CUBE_MAP,O.__webglTexture,r.TEXTURE0+g)}const te={[hn]:r.REPEAT,[Ai]:r.CLAMP_TO_EDGE,[un]:r.MIRRORED_REPEAT},pe={[Tt]:r.NEAREST,[bl]:r.NEAREST_MIPMAP_NEAREST,[Rr]:r.NEAREST_MIPMAP_LINEAR,[kt]:r.LINEAR,[xa]:r.LINEAR_MIPMAP_NEAREST,[Ri]:r.LINEAR_MIPMAP_LINEAR},Pe={[Cl]:r.NEVER,[Nl]:r.ALWAYS,[Pl]:r.LESS,[vo]:r.LEQUAL,[Ll]:r.EQUAL,[Il]:r.GEQUAL,[Dl]:r.GREATER,[Ul]:r.NOTEQUAL};function Ie(E,g){if(g.type===Wt&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===kt||g.magFilter===xa||g.magFilter===Rr||g.magFilter===Ri||g.minFilter===kt||g.minFilter===xa||g.minFilter===Rr||g.minFilter===Ri)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(E,r.TEXTURE_WRAP_S,te[g.wrapS]),r.texParameteri(E,r.TEXTURE_WRAP_T,te[g.wrapT]),(E===r.TEXTURE_3D||E===r.TEXTURE_2D_ARRAY)&&r.texParameteri(E,r.TEXTURE_WRAP_R,te[g.wrapR]),r.texParameteri(E,r.TEXTURE_MAG_FILTER,pe[g.magFilter]),r.texParameteri(E,r.TEXTURE_MIN_FILTER,pe[g.minFilter]),g.compareFunction&&(r.texParameteri(E,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(E,r.TEXTURE_COMPARE_FUNC,Pe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Tt||g.minFilter!==Rr&&g.minFilter!==Ri||g.type===Wt&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");r.texParameterf(E,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,a.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function $e(E,g){let O=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",R));const k=g.source;let Y=d.get(k);Y===void 0&&(Y={},d.set(k,Y));const j=H(g);if(j!==E.__cacheKey){Y[j]===void 0&&(Y[j]={texture:r.createTexture(),usedTimes:0},s.memory.textures++,O=!0),Y[j].usedTimes++;const ye=Y[E.__cacheKey];ye!==void 0&&(Y[E.__cacheKey].usedTimes--,ye.usedTimes===0&&S(g)),E.__cacheKey=j,E.__webglTexture=Y[j].texture}return O}function Xe(E,g,O){return Math.floor(Math.floor(E/O)/g)}function W(E,g,O,k){const Y=E.updateRanges;if(Y.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,g.width,g.height,O,k,g.data);else{Y.sort((he,$)=>he.start-$.start);let j=0;for(let he=1;he<Y.length;he++){const $=Y[j],le=Y[he],Le=$.start+$.count,ve=Xe(le.start,g.width,4),oe=Xe($.start,g.width,4);le.start<=Le+1&&ve===oe&&Xe(le.start+le.count-1,g.width,4)===ve?$.count=Math.max($.count,le.start+le.count-$.start):(++j,Y[j]=le)}Y.length=j+1;const ye=r.getParameter(r.UNPACK_ROW_LENGTH),ie=r.getParameter(r.UNPACK_SKIP_PIXELS),Me=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,g.width);for(let he=0,$=Y.length;he<$;he++){const le=Y[he],Le=Math.floor(le.start/4),ve=Math.ceil(le.count/4),oe=Le%g.width,Oe=Math.floor(Le/g.width),D=ve;r.pixelStorei(r.UNPACK_SKIP_PIXELS,oe),r.pixelStorei(r.UNPACK_SKIP_ROWS,Oe),t.texSubImage2D(r.TEXTURE_2D,0,oe,Oe,D,1,O,k,g.data)}E.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,ye),r.pixelStorei(r.UNPACK_SKIP_PIXELS,ie),r.pixelStorei(r.UNPACK_SKIP_ROWS,Me)}}function ne(E,g,O){let k=r.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(k=r.TEXTURE_2D_ARRAY),g.isData3DTexture&&(k=r.TEXTURE_3D);const Y=$e(E,g),j=g.source;t.bindTexture(k,E.__webglTexture,r.TEXTURE0+O);const ye=i.get(j);if(j.version!==ye.__version||Y===!0){t.activeTexture(r.TEXTURE0+O);const ie=Ve.getPrimaries(Ve.workingColorSpace),Me=g.colorSpace===ci?null:Ve.getPrimaries(g.colorSpace),he=g.colorSpace===ci||ie===Me?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,he);let $=x(g.image,!1,a.maxTextureSize);$=ht(g,$);const le=n.convert(g.format,g.colorSpace),Le=n.convert(g.type);let ve=b(g.internalFormat,le,Le,g.colorSpace,g.isVideoTexture);Ie(k,g);let oe;const Oe=g.mipmaps,D=g.isVideoTexture!==!0,ee=ye.__version===void 0||Y===!0,re=j.dataReady,ge=P(g,$);if(g.isDepthTexture)ve=y(g.format===Sr,g.type),ee&&(D?t.texStorage2D(r.TEXTURE_2D,1,ve,$.width,$.height):t.texImage2D(r.TEXTURE_2D,0,ve,$.width,$.height,0,le,Le,null));else if(g.isDataTexture)if(Oe.length>0){D&&ee&&t.texStorage2D(r.TEXTURE_2D,ge,ve,Oe[0].width,Oe[0].height);for(let J=0,q=Oe.length;J<q;J++)oe=Oe[J],D?re&&t.texSubImage2D(r.TEXTURE_2D,J,0,0,oe.width,oe.height,le,Le,oe.data):t.texImage2D(r.TEXTURE_2D,J,ve,oe.width,oe.height,0,le,Le,oe.data);g.generateMipmaps=!1}else D?(ee&&t.texStorage2D(r.TEXTURE_2D,ge,ve,$.width,$.height),re&&W(g,$,le,Le)):t.texImage2D(r.TEXTURE_2D,0,ve,$.width,$.height,0,le,Le,$.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){D&&ee&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,ve,Oe[0].width,Oe[0].height,$.depth);for(let J=0,q=Oe.length;J<q;J++)if(oe=Oe[J],g.format!==Bt)if(le!==null)if(D){if(re)if(g.layerUpdates.size>0){const me=Fs(oe.width,oe.height,g.format,g.type);for(const Te of g.layerUpdates){const st=oe.data.subarray(Te*me/oe.data.BYTES_PER_ELEMENT,(Te+1)*me/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,J,0,0,Te,oe.width,oe.height,1,le,st)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,J,0,0,0,oe.width,oe.height,$.depth,le,oe.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,J,ve,oe.width,oe.height,$.depth,0,oe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?re&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,J,0,0,0,oe.width,oe.height,$.depth,le,Le,oe.data):t.texImage3D(r.TEXTURE_2D_ARRAY,J,ve,oe.width,oe.height,$.depth,0,le,Le,oe.data)}else{D&&ee&&t.texStorage2D(r.TEXTURE_2D,ge,ve,Oe[0].width,Oe[0].height);for(let J=0,q=Oe.length;J<q;J++)oe=Oe[J],g.format!==Bt?le!==null?D?re&&t.compressedTexSubImage2D(r.TEXTURE_2D,J,0,0,oe.width,oe.height,le,oe.data):t.compressedTexImage2D(r.TEXTURE_2D,J,ve,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?re&&t.texSubImage2D(r.TEXTURE_2D,J,0,0,oe.width,oe.height,le,Le,oe.data):t.texImage2D(r.TEXTURE_2D,J,ve,oe.width,oe.height,0,le,Le,oe.data)}else if(g.isDataArrayTexture)if(D){if(ee&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,ve,$.width,$.height,$.depth),re)if(g.layerUpdates.size>0){const J=Fs($.width,$.height,g.format,g.type);for(const q of g.layerUpdates){const me=$.data.subarray(q*J/$.data.BYTES_PER_ELEMENT,(q+1)*J/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,q,$.width,$.height,1,le,Le,me)}g.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,le,Le,$.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,ve,$.width,$.height,$.depth,0,le,Le,$.data);else if(g.isData3DTexture)D?(ee&&t.texStorage3D(r.TEXTURE_3D,ge,ve,$.width,$.height,$.depth),re&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,le,Le,$.data)):t.texImage3D(r.TEXTURE_3D,0,ve,$.width,$.height,$.depth,0,le,Le,$.data);else if(g.isFramebufferTexture){if(ee)if(D)t.texStorage2D(r.TEXTURE_2D,ge,ve,$.width,$.height);else{let J=$.width,q=$.height;for(let me=0;me<ge;me++)t.texImage2D(r.TEXTURE_2D,me,ve,J,q,0,le,Le,null),J>>=1,q>>=1}}else if(Oe.length>0){if(D&&ee){const J=rt(Oe[0]);t.texStorage2D(r.TEXTURE_2D,ge,ve,J.width,J.height)}for(let J=0,q=Oe.length;J<q;J++)oe=Oe[J],D?re&&t.texSubImage2D(r.TEXTURE_2D,J,0,0,le,Le,oe):t.texImage2D(r.TEXTURE_2D,J,ve,le,Le,oe);g.generateMipmaps=!1}else if(D){if(ee){const J=rt($);t.texStorage2D(r.TEXTURE_2D,ge,ve,J.width,J.height)}re&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,le,Le,$)}else t.texImage2D(r.TEXTURE_2D,0,ve,le,Le,$);f(g)&&h(k),ye.__version=j.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function ae(E,g,O){if(g.image.length!==6)return;const k=$e(E,g),Y=g.source;t.bindTexture(r.TEXTURE_CUBE_MAP,E.__webglTexture,r.TEXTURE0+O);const j=i.get(Y);if(Y.version!==j.__version||k===!0){t.activeTexture(r.TEXTURE0+O);const ye=Ve.getPrimaries(Ve.workingColorSpace),ie=g.colorSpace===ci?null:Ve.getPrimaries(g.colorSpace),Me=g.colorSpace===ci||ye===ie?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me);const he=g.isCompressedTexture||g.image[0].isCompressedTexture,$=g.image[0]&&g.image[0].isDataTexture,le=[];for(let q=0;q<6;q++)!he&&!$?le[q]=x(g.image[q],!0,a.maxCubemapSize):le[q]=$?g.image[q].image:g.image[q],le[q]=ht(g,le[q]);const Le=le[0],ve=n.convert(g.format,g.colorSpace),oe=n.convert(g.type),Oe=b(g.internalFormat,ve,oe,g.colorSpace),D=g.isVideoTexture!==!0,ee=j.__version===void 0||k===!0,re=Y.dataReady;let ge=P(g,Le);Ie(r.TEXTURE_CUBE_MAP,g);let J;if(he){D&&ee&&t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,Oe,Le.width,Le.height);for(let q=0;q<6;q++){J=le[q].mipmaps;for(let me=0;me<J.length;me++){const Te=J[me];g.format!==Bt?ve!==null?D?re&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me,0,0,Te.width,Te.height,ve,Te.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me,Oe,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me,0,0,Te.width,Te.height,ve,oe,Te.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me,Oe,Te.width,Te.height,0,ve,oe,Te.data)}}}else{if(J=g.mipmaps,D&&ee){J.length>0&&ge++;const q=rt(le[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,Oe,q.width,q.height)}for(let q=0;q<6;q++)if($){D?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,le[q].width,le[q].height,ve,oe,le[q].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Oe,le[q].width,le[q].height,0,ve,oe,le[q].data);for(let me=0;me<J.length;me++){const Te=J[me].image[q].image;D?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me+1,0,0,Te.width,Te.height,ve,oe,Te.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me+1,Oe,Te.width,Te.height,0,ve,oe,Te.data)}}else{D?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,ve,oe,le[q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Oe,ve,oe,le[q]);for(let me=0;me<J.length;me++){const Te=J[me];D?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me+1,0,0,ve,oe,Te.image[q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+q,me+1,Oe,ve,oe,Te.image[q])}}}f(g)&&h(r.TEXTURE_CUBE_MAP),j.__version=Y.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Ee(E,g,O,k,Y,j){const ye=n.convert(O.format,O.colorSpace),ie=n.convert(O.type),Me=b(O.internalFormat,ye,ie,O.colorSpace),he=i.get(g),$=i.get(O);if($.__renderTarget=g,!he.__hasExternalTextures){const le=Math.max(1,g.width>>j),Le=Math.max(1,g.height>>j);Y===r.TEXTURE_3D||Y===r.TEXTURE_2D_ARRAY?t.texImage3D(Y,j,Me,le,Le,g.depth,0,ye,ie,null):t.texImage2D(Y,j,Me,le,Le,0,ye,ie,null)}t.bindFramebuffer(r.FRAMEBUFFER,E),fe(g)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,k,Y,$.__webglTexture,0,Qe(g)):(Y===r.TEXTURE_2D||Y>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,k,Y,$.__webglTexture,j),t.bindFramebuffer(r.FRAMEBUFFER,null)}function be(E,g,O){if(r.bindRenderbuffer(r.RENDERBUFFER,E),g.depthBuffer){const k=g.depthTexture,Y=k&&k.isDepthTexture?k.type:null,j=y(g.stencilBuffer,Y),ye=g.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ie=Qe(g);fe(g)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ie,j,g.width,g.height):O?r.renderbufferStorageMultisample(r.RENDERBUFFER,ie,j,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,j,g.width,g.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,ye,r.RENDERBUFFER,E)}else{const k=g.textures;for(let Y=0;Y<k.length;Y++){const j=k[Y],ye=n.convert(j.format,j.colorSpace),ie=n.convert(j.type),Me=b(j.internalFormat,ye,ie,j.colorSpace),he=Qe(g);O&&fe(g)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,he,Me,g.width,g.height):fe(g)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,he,Me,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,Me,g.width,g.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function _e(E,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const O=i.get(g.depthTexture);O.__renderTarget=g,(!O.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K(g.depthTexture,0);const k=O.__webglTexture,Y=Qe(g);if(g.depthTexture.format===Mr)fe(g)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,k,0,Y):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,k,0);else if(g.depthTexture.format===Sr)fe(g)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,k,0,Y):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,k,0);else throw new Error("Unknown depthTexture format")}function Ge(E){const g=i.get(E),O=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const k=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),k){const Y=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,k.removeEventListener("dispose",Y)};k.addEventListener("dispose",Y),g.__depthDisposeCallback=Y}g.__boundDepthTexture=k}if(E.depthTexture&&!g.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");const k=E.texture.mipmaps;k&&k.length>0?_e(g.__webglFramebuffer[0],E):_e(g.__webglFramebuffer,E)}else if(O){g.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer[k]),g.__webglDepthbuffer[k]===void 0)g.__webglDepthbuffer[k]=r.createRenderbuffer(),be(g.__webglDepthbuffer[k],E,!1);else{const Y=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,j=g.__webglDepthbuffer[k];r.bindRenderbuffer(r.RENDERBUFFER,j),r.framebufferRenderbuffer(r.FRAMEBUFFER,Y,r.RENDERBUFFER,j)}}else{const k=E.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=r.createRenderbuffer(),be(g.__webglDepthbuffer,E,!1);else{const Y=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,j=g.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,j),r.framebufferRenderbuffer(r.FRAMEBUFFER,Y,r.RENDERBUFFER,j)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function je(E,g,O){const k=i.get(E);g!==void 0&&Ee(k.__webglFramebuffer,E,E.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),O!==void 0&&Ge(E)}function A(E){const g=E.texture,O=i.get(E),k=i.get(g);E.addEventListener("dispose",C);const Y=E.textures,j=E.isWebGLCubeRenderTarget===!0,ye=Y.length>1;if(ye||(k.__webglTexture===void 0&&(k.__webglTexture=r.createTexture()),k.__version=g.version,s.memory.textures++),j){O.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[ie]=[];for(let Me=0;Me<g.mipmaps.length;Me++)O.__webglFramebuffer[ie][Me]=r.createFramebuffer()}else O.__webglFramebuffer[ie]=r.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let ie=0;ie<g.mipmaps.length;ie++)O.__webglFramebuffer[ie]=r.createFramebuffer()}else O.__webglFramebuffer=r.createFramebuffer();if(ye)for(let ie=0,Me=Y.length;ie<Me;ie++){const he=i.get(Y[ie]);he.__webglTexture===void 0&&(he.__webglTexture=r.createTexture(),s.memory.textures++)}if(E.samples>0&&fe(E)===!1){O.__webglMultisampledFramebuffer=r.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ie=0;ie<Y.length;ie++){const Me=Y[ie];O.__webglColorRenderbuffer[ie]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,O.__webglColorRenderbuffer[ie]);const he=n.convert(Me.format,Me.colorSpace),$=n.convert(Me.type),le=b(Me.internalFormat,he,$,Me.colorSpace,E.isXRRenderTarget===!0),Le=Qe(E);r.renderbufferStorageMultisample(r.RENDERBUFFER,Le,le,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ie,r.RENDERBUFFER,O.__webglColorRenderbuffer[ie])}r.bindRenderbuffer(r.RENDERBUFFER,null),E.depthBuffer&&(O.__webglDepthRenderbuffer=r.createRenderbuffer(),be(O.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(j){t.bindTexture(r.TEXTURE_CUBE_MAP,k.__webglTexture),Ie(r.TEXTURE_CUBE_MAP,g);for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0)for(let Me=0;Me<g.mipmaps.length;Me++)Ee(O.__webglFramebuffer[ie][Me],E,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Me);else Ee(O.__webglFramebuffer[ie],E,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);f(g)&&h(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let ie=0,Me=Y.length;ie<Me;ie++){const he=Y[ie],$=i.get(he);let le=r.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(le=E.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(le,$.__webglTexture),Ie(le,he),Ee(O.__webglFramebuffer,E,he,r.COLOR_ATTACHMENT0+ie,le,0),f(he)&&h(le)}t.unbindTexture()}else{let ie=r.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ie=E.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ie,k.__webglTexture),Ie(ie,g),g.mipmaps&&g.mipmaps.length>0)for(let Me=0;Me<g.mipmaps.length;Me++)Ee(O.__webglFramebuffer[Me],E,g,r.COLOR_ATTACHMENT0,ie,Me);else Ee(O.__webglFramebuffer,E,g,r.COLOR_ATTACHMENT0,ie,0);f(g)&&h(ie),t.unbindTexture()}E.depthBuffer&&Ge(E)}function ct(E){const g=E.textures;for(let O=0,k=g.length;O<k;O++){const Y=g[O];if(f(Y)){const j=T(E),ye=i.get(Y).__webglTexture;t.bindTexture(j,ye),h(j),t.unbindTexture()}}}const He=[],qe=[];function Se(E){if(E.samples>0){if(fe(E)===!1){const g=E.textures,O=E.width,k=E.height;let Y=r.COLOR_BUFFER_BIT;const j=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ye=i.get(E),ie=g.length>1;if(ie)for(let he=0;he<g.length;he++)t.bindFramebuffer(r.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,ye.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer);const Me=E.texture.mipmaps;Me&&Me.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ye.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let he=0;he<g.length;he++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Y|=r.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Y|=r.STENCIL_BUFFER_BIT)),ie){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,ye.__webglColorRenderbuffer[he]);const $=i.get(g[he]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,$,0)}r.blitFramebuffer(0,0,O,k,0,0,O,k,Y,r.NEAREST),c===!0&&(He.length=0,qe.length=0,He.push(r.COLOR_ATTACHMENT0+he),E.depthBuffer&&E.resolveDepthBuffer===!1&&(He.push(j),qe.push(j),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,qe)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,He))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ie)for(let he=0;he<g.length;he++){t.bindFramebuffer(r.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.RENDERBUFFER,ye.__webglColorRenderbuffer[he]);const $=i.get(g[he]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,ye.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.TEXTURE_2D,$,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const g=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[g])}}}function Qe(E){return Math.min(a.maxSamples,E.samples)}function fe(E){const g=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ne(E){const g=s.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function ht(E,g){const O=E.colorSpace,k=E.format,Y=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||O!==ar&&O!==ci&&(Ve.getTransfer(O)===We?(k!==Bt||Y!==jt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),g}function rt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=V,this.resetTextureUnits=F,this.setTexture2D=K,this.setTexture2DArray=X,this.setTexture3D=Q,this.setTextureCube=G,this.rebindTextures=je,this.setupRenderTarget=A,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=Se,this.setupDepthRenderbuffer=Ge,this.setupFrameBufferTexture=Ee,this.useMultisampledRTT=fe}function Jp(r,e){function t(i,a=ci){let n;const s=Ve.getTransfer(a);if(i===jt)return r.UNSIGNED_BYTE;if(i===Vn)return r.UNSIGNED_SHORT_4_4_4_4;if(i===Gn)return r.UNSIGNED_SHORT_5_5_5_1;if(i===po)return r.UNSIGNED_INT_5_9_9_9_REV;if(i===ho)return r.BYTE;if(i===uo)return r.SHORT;if(i===vr)return r.UNSIGNED_SHORT;if(i===Hn)return r.INT;if(i===Ci)return r.UNSIGNED_INT;if(i===Wt)return r.FLOAT;if(i===yr)return r.HALF_FLOAT;if(i===fo)return r.ALPHA;if(i===mo)return r.RGB;if(i===Bt)return r.RGBA;if(i===Mr)return r.DEPTH_COMPONENT;if(i===Sr)return r.DEPTH_STENCIL;if(i===kn)return r.RED;if(i===Wn)return r.RED_INTEGER;if(i===go)return r.RG;if(i===Xn)return r.RG_INTEGER;if(i===jn)return r.RGBA_INTEGER;if(i===ea||i===ta||i===ia||i===ra)if(s===We)if(n=e.get("WEBGL_compressed_texture_s3tc_srgb"),n!==null){if(i===ea)return n.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ta)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ia)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ra)return n.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(n=e.get("WEBGL_compressed_texture_s3tc"),n!==null){if(i===ea)return n.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ta)return n.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ia)return n.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ra)return n.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===dn||i===pn||i===fn||i===mn)if(n=e.get("WEBGL_compressed_texture_pvrtc"),n!==null){if(i===dn)return n.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===pn)return n.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===fn)return n.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===mn)return n.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===gn||i===_n||i===vn)if(n=e.get("WEBGL_compressed_texture_etc"),n!==null){if(i===gn||i===_n)return s===We?n.COMPRESSED_SRGB8_ETC2:n.COMPRESSED_RGB8_ETC2;if(i===vn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:n.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===xn||i===Mn||i===Sn||i===yn||i===En||i===Tn||i===bn||i===wn||i===An||i===Rn||i===Cn||i===Pn||i===Ln||i===Dn)if(n=e.get("WEBGL_compressed_texture_astc"),n!==null){if(i===xn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:n.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Mn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:n.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Sn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:n.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===yn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:n.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===En)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:n.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Tn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:n.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===bn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:n.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===wn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:n.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===An)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:n.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Rn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:n.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Cn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:n.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Pn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:n.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ln)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:n.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Dn)return s===We?n.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:n.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===aa||i===Un||i===In)if(n=e.get("EXT_texture_compression_bptc"),n!==null){if(i===aa)return s===We?n.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:n.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Un)return n.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===In)return n.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===_o||i===Nn||i===On||i===Fn)if(n=e.get("EXT_texture_compression_rgtc"),n!==null){if(i===aa)return n.COMPRESSED_RED_RGTC1_EXT;if(i===Nn)return n.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===On)return n.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Fn)return n.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===xr?r.UNSIGNED_INT_24_8:r[i]!==void 0?r[i]:null}return{convert:t}}class Go extends vt{constructor(e=null){super(),this.sourceTexture=e,this.isExternalTexture=!0}}const $p=`
void main() {
